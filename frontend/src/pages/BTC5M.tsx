            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-bold text-slate-700">
                {targetSettings?.slot_mode === 'double_slot_2.5m' 
                  ? `$${targetSettings?.tp_dollar ? Number(targetSettings.tp_dollar).toFixed(2) : '1.00'} TP / $${targetSettings?.sl_dollar ? Number(targetSettings.sl_dollar).toFixed(2) : '1.00'} SL (1:1 Scalp)` 
                  : `$${targetSettings?.tp_dollar ? Number(targetSettings.tp_dollar).toFixed(2) : '1.00'} TP / $${targetSettings?.sl_dollar ? Number(targetSettings.sl_dollar).toFixed(2) : '1.00'} SL (1:1 Trend)`}
              </span>
            </div>
            <div className="flex justify-between items-center">
