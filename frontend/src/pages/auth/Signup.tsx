  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center space-y-1">
        ...
        <p className="text-xs text-slate-400 font-mono">BTC 5M Quantitative Trading & Prediction Engine</p>
      </div>
      ...
      <form className="space-y-3.5" onSubmit={handleEmailSignup}>
        ...
        >
          {loading ? <RefreshCw className="w-4 h-4 animate-spin" /> : 'Create Free Account'}
        </button>
      </form>
